// Experiment, prime factors in parallel, like primeFactors.fsx
// sestoft@itu.dk * 2016-03-16
// nh@itu.dk * 2025-04-06
namespace FactorsParalle;
...
class MyTest {
  private static int[] histogram = new int[400000];

  public static void Main(String[] args) {
    SystemInfo();
    {
      Timer t = new Timer();
      List<int>[] factors400000 = new List<int>[400000];
      for (int n=0; n<400000; n++) 
        factors400000[n] = Factors(n);
      PrintHistogram();
      Console.WriteLine("{0:F3} sec", t.Check());
    }
    histogram = new int[400000];
    {
      Timer t = new Timer();
      List<int>[] factors400000 = new List<int>[400000];
      Parallel.For(0, 400000, 
		    n => { factors400000[n] = Factors(n); });
      PrintHistogram();
      Console.WriteLine("{0:F3} sec", t.Check());
    }
  }
