...
// functions cannot be compared. Float, int, string etc can compare. 
// slide 12, week 2. 
// let f = fun m -> match m with ...
// let f = function .. 
// 
...
let f (x, y) = x + y;; // takes one argument. 
let f x y = x + y;; // takes two arguments. 


( + ) 3  5 ;; 

// when guards slide 24 week 2 slides. 
