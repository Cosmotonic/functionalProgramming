...
public class TestCountPrimesStream {
  public static void Main(String[] args) {
    ...
    int range = 400000;
    Timer t = new Timer();
    var factors400000 = countStreamParallelChunk(range);
    // PrintFew(15, factors400000);
    int[] histogram = FactorFrequencies(range, factors400000);
    Console.WriteLine("Time = {0,8:F3} sec", t.Check());
    PrintFew(15, histogram);

    t = new Timer();
    factors400000 = countStreamParallelRange(range);    
    histogram = FactorFrequencies(range, factors400000);
    Console.WriteLine("Time = {0,8:F3} sec", t.Check());
    PrintFew(15, histogram);
  }
